...
const Signup = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/auth/register', user_data);
        ...
        <div className="flex flex-col h-screen w-screen">
            <div className="flex-grow flex flex-col">
                <div className="flex flex-col md:flex-row w-full h-full bg-white overflow-hidden">
                    ...
                    <p className="text-sm mb-28 text-gray-400 text-center">Already Registered? <Link to="/login" className="text-lightBlue">Login</Link></p>
